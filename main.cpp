...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	//Shaderをコンパイルする
	IDxcBlob* vertexShaderBlob = CompileShader(L"Object3d.VS.hlsl", L"vs_6_0", dxcUtils, dxcCompiler, includeHandle);
	assert(vertexShaderBlob != nullptr);

	IDxcBlob* pixelShaderBlob = CompileShader(L"Object3d.PS.hlsl", L"ps_6_0", dxcUtils, dxcCompiler, includeHandle);
...
#pragma endregion
			...
			ImGui::SliderFloat3("direction", directionPos, -1.0f, 1.0f);
			ImGui::End();

			directionalLightData->direction.x = directionPos[0];
			directionalLightData->direction.y = directionPos[1];
			directionalLightData->direction.z = directionPos[2];
